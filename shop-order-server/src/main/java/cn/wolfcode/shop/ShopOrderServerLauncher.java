...
@PropertySource({"classpath:application.properties","classpath:activeMq.properties"})
public class ShopOrderServerLauncher {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext ctx = SpringApplication.run(ShopOrderServerLauncher.class, args);
        //使用锁防止容器运行后直接关闭
